...
X = [
    ...
    % 11~15: t_first (5x1)
    1.5; 1.0; 1.0; 1.0; 1.0;
    % 16~20: dt12_extra (5x1) (实际间隔为 1 + dt_extra)
    0.5; 0.0; 0.0; 0.0; 0.0;
    % 21~25: dt23_extra (5x1)
    0.5; 0.0; 0.0; 0.0; 0.0;
    % 26~35: t_delay_matrix 按列（或按行）拉直。这里为了好对应，按行展开成 15x1
    3.6; 9999; 9999;  % FY1 的 3 枚弹延迟
    9999; 9999; 9999; % FY2 的 3 枚弹延迟
    9999; 9999; 9999; % FY3 的 3 枚弹延迟
    9999; 9999; 9999; % FY4 的 3 枚弹延迟
    9999; 9999; 9999  % FY5 的 3 枚弹延迟
];
